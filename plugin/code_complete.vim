...
let g:template['c']['co0'] = "std::cout<<\" \"<<endl;\<left>\<left>\<left>\<left>\<left>\<left>\<left>\<left>\<left>"
let g:template['c']['co'] = "std::cout<<\"".g:rs."...".g:re."  : \"<<".g:rs."...".g:re."<<endl;\<left>\<left>\<left>\<left>\<left>\<left>\<left>\<left>\<left>\<left>\<left>\<left>\<left>\<left>\<left>"
...
let g:template['c']['ff'] = "#ifndef  \<c-r>=GetFileName()\<cr>\<CR>#define  \<c-r>=GetFileName()\<cr>".repeat("\<cr>",5)."#endif  /*\<c-r>=GetFileName()\<cr>*/".repeat("\<up>",3)
let g:template['c']['for'] = "for( ".g:rs."...".g:re." ; ".g:rs."...".g:re." ; ".g:rs."...".g:re." )\<cr>{\<cr>".g:rs."...".g:re."\<cr>}\<cr>"
